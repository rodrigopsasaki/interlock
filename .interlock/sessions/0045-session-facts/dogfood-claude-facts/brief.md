...
gates:
  ...
  - id: claude-facts-position
    kind: command
    run: pnpm interlock session show 0045-session-facts dogfood-claude-facts
    expect_output: "Prompt received: yes[\\s\\S]*Last activity:
      \\d{4}-\\d{2}-\\d{2}T[^\\n]+[\\s\\S]*Usage:
      (?!unknown)[^\\n]+[\\s\\S]*Quota: [^\\n]+"
scope:
  - .gitignore
  ...
  - .interlock/sessions/0045-session-facts/brief-authoring-path/debrief-candidate.yaml
  - .interlock/sessions/0045-session-facts/brief-authoring-path/debrief.yaml
  - .interlock/sessions/0045-session-facts/brief-authoring-path/notes.yaml
  - .interlock/sessions/0045-session-facts/brief-authoring-path/revisions/f2ca83fea6274394e5262274c1f1d8ecede0f6df9c30db5f68f9e7a3a72feffc.yaml
  - .interlock/sessions/0045-session-facts/claude-session-reader/brief.md
  - .interlock/sessions/0045-session-facts/claude-session-reader/debrief-candidate.yaml
  - .interlock/sessions/0045-session-facts/claude-session-reader/debrief.yaml
  - .interlock/sessions/0045-session-facts/claude-session-reader/notes.yaml
  - .interlock/sessions/0045-session-facts/codex-session-reader/brief.md
  - .interlock/sessions/0045-session-facts/codex-session-reader/debrief-candidate-final.yaml
  - .interlock/sessions/0045-session-facts/codex-session-reader/debrief-candidate.yaml
  - .interlock/sessions/0045-session-facts/codex-session-reader/debrief.yaml
  - .interlock/sessions/0045-session-facts/codex-session-reader/notes.yaml
  - .interlock/sessions/0045-session-facts/codex-session-reader/revisions/a117ef0018711e76672bdb0e3716a488a0603cf5b93c4349eaa9223d6aa6577c.yaml
  - .interlock/sessions/0045-session-facts/dogfood-claude-facts/brief.md
  - .interlock/sessions/0045-session-facts/dogfood-codex-facts/brief.md
  ...
  - .interlock/sessions/0045-session-facts/prompt-delivery-facts/brief.md
  - .interlock/sessions/0045-session-facts/prompt-delivery-facts/debrief-candidate.yaml
  - .interlock/sessions/0045-session-facts/prompt-delivery-facts/debrief.yaml
  - .interlock/sessions/0045-session-facts/prompt-delivery-facts/notes.yaml
  - .interlock/sessions/0045-session-facts/runner-artifact-boundary/brief.md
  - .interlock/sessions/0045-session-facts/runner-artifact-boundary/debrief-candidate-2.yaml
  - .interlock/sessions/0045-session-facts/runner-artifact-boundary/debrief-candidate-3.yaml
  - .interlock/sessions/0045-session-facts/runner-artifact-boundary/debrief-candidate.yaml
  - .interlock/sessions/0045-session-facts/runner-artifact-boundary/debrief.yaml
  - .interlock/sessions/0045-session-facts/runner-artifact-boundary/notes.yaml
  - .interlock/sessions/0045-session-facts/runner-artifact-boundary/revisions/6aadae745beb2de6d191b389408842bf51f716bcc59aaadafc0ab284c700bfb4.yaml
  - .interlock/sessions/0045-session-facts/session-facts-position/brief.md
  - .interlock/sessions/0045-session-facts/session-facts-position/debrief-candidate.yaml
  - .interlock/sessions/0045-session-facts/session-facts-position/debrief.yaml
  - .interlock/sessions/0045-session-facts/session-facts-position/notes.yaml
  - .interlock/sessions/0045-session-facts/session-facts-seam/brief.md
  - .interlock/sessions/0045-session-facts/session-facts-seam/debrief-candidate-revision.yaml
  - .interlock/sessions/0045-session-facts/session-facts-seam/debrief-candidate.yaml
  - .interlock/sessions/0045-session-facts/session-facts-seam/debrief.yaml
  - .interlock/sessions/0045-session-facts/session-facts-seam/notes.yaml
  - .interlock/sessions/0045-session-facts/session-facts-seam/revisions/dae0dc33cee3ca90a6044b8711140d666c87e4b8565ae034479a8cb660c1c839.yaml
  ...
  - packages/runner/test/fixtures/claude/empty.jsonl
  - packages/runner/test/fixtures/claude/malformed.jsonl
  - packages/runner/test/fixtures/claude/no-opening-prompt.jsonl
  - packages/runner/test/fixtures/claude/session-with-usage.jsonl
  - packages/runner/test/fixtures/codex-rollouts/dropped-opening-prompt.jsonl
  - packages/runner/test/fixtures/codex-rollouts/latest-optional-missing.jsonl
  - packages/runner/test/fixtures/codex-rollouts/malformed.jsonl
  - packages/runner/test/fixtures/codex-rollouts/opening-prompt-resend.jsonl
  ...
  - packages/runner/test/judgeWorktree.test.ts
  ...
  - packages/runner/test/sessionFacts/claude.test.ts
  - packages/runner/test/sessionFacts/codex.test.ts
  - packages/runner/test/sessionFacts/paths.test.ts
...
substrate:
  address: none
graph_base_sha: fe03cfe04204dd279d321affc7fe7710c94b99c1
session: 73a1f163-b3bd-4e96-a548-7aee5546897a
---

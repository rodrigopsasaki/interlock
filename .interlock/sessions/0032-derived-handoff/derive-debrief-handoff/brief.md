...
gates:
  ...
  - id: derived-handoff-proof
    kind: command
    run: pnpm --filter debrief --filter cli --fail-if-no-match test
...
session: 20edba14-6eac-460c-a9c0-b14b76127b82
---

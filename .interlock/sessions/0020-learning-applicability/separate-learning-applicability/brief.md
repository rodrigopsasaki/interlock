...
gates:
  ...
  - id: learning-contract
    ...
    run: pnpm --filter substrate --fail-if-no-match exec vitest run
      test/evidence.test.ts test/wire.test.ts --reporter=verbose
...
session: 0bda0c0d-0f62-4254-95e5-c064a5f40643
---

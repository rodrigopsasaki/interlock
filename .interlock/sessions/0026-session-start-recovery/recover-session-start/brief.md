...
gates:
  ...
  - id: recovery-proof
    kind: command
    run: pnpm --filter cli --filter debrief --fail-if-no-match test
...
session: 9e2a202b-1f4d-4177-846d-9119fdeccaa9
---
...
- [observed, path packages/cli/src/debrief/revise.ts] Nothing is held about packages/cli/src/debrief/revise.ts.
  derivation: preston:coverage@v1

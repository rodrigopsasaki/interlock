...
gates:
  ...
  - id: current-and-retained
    kind: command
    run: pnpm --filter cli --filter schemas --fail-if-no-match test
...
session: 920beb78-7e89-4f13-bdcd-653968c0eb14
---

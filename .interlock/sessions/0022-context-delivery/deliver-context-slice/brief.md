...
gates:
  ...
  - id: context-composition
    ...
    run: pnpm --filter runner --fail-if-no-match exec vitest run
      test/sessionBrief.test.ts --reporter=verbose
...
session: 415d9412-b324-4d5a-9e4a-e0db071135bb
---
...
- [observed, path packages/runner/src/openingView.ts] Nothing is held about packages/runner/src/openingView.ts.
  derivation: preston:coverage@v1

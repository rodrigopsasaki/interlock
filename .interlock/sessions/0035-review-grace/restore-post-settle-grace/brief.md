...
gates:
  ...
  - id: session-wait-grace-proof
    kind: command
    run: pnpm --filter runner exec vitest run test/sessionWait.test.ts
...
graph_base_sha: b9c05f97ab1718bc0524dfdcd1824d9c43c1de61
session: 50fd68cb-9a73-4ed4-b7ff-69fbae07d4eb
---

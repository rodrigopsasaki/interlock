...
gates:
  ...
  - id: dispatch-boundary-proof
    ...
    run: pnpm --filter runner --fail-if-no-match exec vitest run
      ...
      test/absorbStorageBoundary.test.ts --reporter=verbose
...
session: a79849e7-83f3-4240-9516-3467d69769b6
---

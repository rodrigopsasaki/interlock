...
gates:
  ...
  - id: authoring-feedback-proof
    kind: command
    run: pnpm --filter runner --filter cli --filter verifier --fail-if-no-match test
...
graph_base_sha: 162cd1ffaf97d4d6065e77a5a821d2db6ea36337
session: e6561a8e-3ff0-42c2-9538-a5edb2f23972
---
...
- [observed, path packages/runner/src/debriefAuthoringGuidance.ts] Nothing is held about packages/runner/src/debriefAuthoringGuidance.ts.

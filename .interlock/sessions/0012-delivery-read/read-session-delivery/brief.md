...
gates:
  ...
  - id: delivery-read-proof
    kind: command
    run: pnpm --filter cli --fail-if-no-match exec vitest run test/evidence.test.ts
      --reporter=verbose
...
session: a55a955e-8b7e-4594-8aa6-376848d8239a
---

...
// `order` must already be topologically sorted (dependencies before dependents),
// which is exactly what `topologicalOrder` produces.
export function criticalPath(
  order: readonly NodeDeclaration[],
): readonly string[] {
